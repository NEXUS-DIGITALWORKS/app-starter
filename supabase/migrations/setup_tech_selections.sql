...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'tech_selections'
      AND policyname = 'select_own_tech_selections'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'tech_selections'
      AND policyname = 'insert_own_tech_selections'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'tech_selections'
      AND policyname = 'update_own_tech_selections'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'tech_selections'
      AND policyname = 'delete_own_tech_selections'
  ) THEN
